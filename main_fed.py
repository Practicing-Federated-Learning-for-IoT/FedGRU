...
from models.Nets import MLP, CNNMnist, CNNCifar, GRU
from models.Fed import FedAvg
from models.test import test_img
from utils.data import process_data, iid
...
if __name__ == '__main__':
    ...
    if args.model == 'gru':
        ...
        input_num, hidden_num, output_num = 12, 64, 1
        net_glob = GRU(input_num, hidden_num, output_num).to(args.device)
    else:
